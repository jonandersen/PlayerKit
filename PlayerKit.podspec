...
Pod::Spec.new do |s|
  s.name             = 'PlayerKit'
  s.version          = '0.2.3'
  s.summary          = 'A short description of PlayerKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jonandersen/PlayerKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jon Andersen' => 'jon.andersen.se@gmail.com' }
  s.source           = { :git => 'https://github.com/jonandersen/PlayerKit.git', :tag => s.version.to_s }
